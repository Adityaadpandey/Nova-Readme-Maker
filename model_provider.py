...
class OpenAIProvider(ModelProvider):
    ...
    def __init__(self, model: str = "gpt-5-mini-2025-08-07", api_key: Optional[str] = None):
        self.model = model
...
def create_provider(provider_type: str, model: Optional[str] = None, api_key: Optional[str] = None) -> ModelProvider:
    ...
    if provider_type == 'ollama':
        ...
        return OpenAIProvider(model=model or "gpt-5-mini-2025-08-07", api_key=api_key)

    elif provider_type == 'claude':
        return ClaudeProvider(model=model or "claude-sonnet-4-5-20250929", api_key=api_key)
